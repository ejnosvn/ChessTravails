...
public class Knight extends Chessman {
	...
	public List<Field> getValidMoves(int startCol, int startRow, boolean blockedOnly) {
		...
		int[][] f_pos = { {startCol-2,startRow-1}, {startCol-1,startRow-2}, {startCol+1,startRow-2}, {startCol+2,startRow-1}, {startCol-2,startRow+1}, {startCol-1,startRow+2}, {startCol+1,startRow+2}, {startCol+2,startRow+1} };
...
//				System.out.println("f_pos ok:"+ t.getField(f_pos[k][0],f_pos[k][1]).toString());
				if(	(!blockedOnly && t.getField(f_pos[k][0],f_pos[k][1]).isValid())
					||
					(blockedOnly && t.getField(f_pos[k][0],f_pos[k][1]).isNotBlocked())){
